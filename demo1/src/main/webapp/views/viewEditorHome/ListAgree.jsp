...
<jsp:useBean id="listAgree" scope="request" type="java.util.List<com.example.edit.beans.Articles>"/>
    ...
    <div class="container">
      <div class="card w-100 h-100 shadow">
        <div class="card-header d-flex justify-content-md-between">
          <span class="text-title">Agree Articles</span>
        </div>
        <div class="body">
          <table class="table">
            ...
            <tbody>
            <c:forEach items="${listAgree}" var="r">
              <tr>
                ...
                <td>${r.second_name}</td>
                <c:choose>
                  <c:when test="${r.status_id == 101}">
                    <td><span class="badge badge-warning">wait</span></td>
                  </c:when>
                  <c:when test="${r.status_id == 102}">
