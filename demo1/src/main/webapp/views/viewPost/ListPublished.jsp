...
<jsp:useBean id="listPublished" scope="request" type="java.util.List<com.example.edit.beans.Articles>"/>
    ...
    <div class="container">
      <div class="card w-100 h-100 shadow">
        <div class="card-header d-flex justify-content-md-between">
          <span class="text-title">Published Articles</span>
        </div>
        <div class="body">
          <table class="table">
            ...
            <tbody>
            <c:forEach items="${listPublished}" var="r">
              <tr>
