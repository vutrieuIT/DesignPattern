              ...
              <div class="col-md-6 col-lg-7">
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <div class="row mt-5 mb-5 ml-5">
                    <h5 class="fw-normal mr-2 ml-4" style="letter-spacing: 2px;">Giá: </h5>
                    <div class="ml-5">
                      <h5>900.000 Đồng</h5>
                    </div>
                  </div>
                  <div class="row mt-5 mb-5 ml-5">
                    <h5 class="fw-normal mr-2 ml-4" style="letter-spacing: 2px;">Số tài khoản: </h5>
                    <div class="ml-5">
                      <h5>6003205529546</h5>
                    </div>
                  </div>
                  <div class="row mt-5 mb-5 ml-5">
                    <h5 class="fw-normal mr-2 ml-4" style="letter-spacing: 2px;">Ngân hàng: </h5>
                    <div class="ml-5">
                      <h5>Agribank</h5>
                    </div>
                  </div>
