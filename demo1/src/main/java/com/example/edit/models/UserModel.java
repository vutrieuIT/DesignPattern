...
public class UserModel {
    ...
    public static void editAccPre(int user_id,LocalDate issue_at ) {
        ...
        String updateSql = "UPDATE users SET issue_at = :issue_at, premium = 2 WHERE user_id= :user_id ";
        try (Connection con = DbUtils.getConnection()) {
            con.createQuery(updateSql)
    ...
    public static void updateAccPre(int user_id,LocalDate issue_at ) {
    ...
    public static void refuseAccPre(int user_id,LocalDate issue_at ) {

        String updateSql = "UPDATE users SET issue_at = :issue_at, premium = 0 WHERE user_id= :user_id ";
        try (Connection con = DbUtils.getConnection()) {
            con.createQuery(updateSql)
                    .addParameter("issue_at", issue_at)
                    .addParameter("user_id", user_id)
    ...
    static final String PASSWORD = "Ngochai0707";
    ...
    public static List<User> findUserWaitingAccept()
    {
        final String query = "select * from users WHERE premium = 2  ";
        try(Connection con = DbUtils.getConnection()){
            return con.createQuery(query)
                    .executeAndFetch(User.class);
        }
