        ...
        switch (path) {
            ...
            case "/Email":
              try {
                  ...
                  String otp = userBridge.getOtp(email);
                  User uForgot = userBridge.getNameUserByEmail(email);
                  ...
                  userBridge.sendMailToEmail(email,content.toString());
            ...
            case "/OTP":
             try{
                 ...
                 Boolean check = userBridge.checkOtp(Otp,email);
                 if(check == true)
                 {
                     request.setAttribute("email",email);
            ...
            case "/Reset":
                try{
                    ...
                    User change= userBridge.findByEmail(email);
                    ...
                    else
                    {
                        ...
                        userBridge.edit(bcryptHashString,email);
                        request.setAttribute("mess",mess);
                        request.getRequestDispatcher("/views/viewHome/ResetPass.jsp").forward(request,response);
                    }
                }
