...
public class UserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (path) {
            ...
            case "/IsAvailable":
                ...
                boolean isAvailable = userBridge.checkByUserName(username);
    ...
    private void login(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        User user = userBridge.findByUsername(username);
        //boolean check = userBridge.checkByUserName(username);
        if (user != null) {
    ...
    private void editUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        userBridge.editUser(edit.getUserId(), name, email, date_of_birth, secondName);
        session.setAttribute("auth", true);
    ...
    private void editAcc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        HttpSession session = request.getSession();
        User edit = (User) session.getAttribute("authUser");
        userBridge.editAcc(edit.getUserId(), bcryptHashString, username);
        User a = userBridge.findById(edit.getUserId());
        session.setAttribute("auth", true);
    ...
    private void editPre(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String email = request.getParameter("email");
        User uRes = userBridge.getNameUserByEmail(email);
        ...
        userBridge.sendMailToEmailConfirm(email, content.toString());
        request.setAttribute("email", email);
        HttpSession session = request.getSession();
        LocalDate date = LocalDate.now();
        User edit = (User) session.getAttribute("authUser");
        userBridge.editAccPre(edit.getUserId(), date);
